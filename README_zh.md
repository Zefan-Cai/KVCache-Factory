...
- 压缩/检索：`PyramidKV`、`SnapKV`、`Quest`、`NACL`、`H2O`、`StreamingLLM`、`CAM`、`L2Norm`、`AdaKV`、`HeadKV`、`ThinK`
- 合同工具：`Quest` 风格 query-aware page/token selector、`NACL` 风格 proxy/random eviction selector、`LOOK-M` 风格 `pivot` merge、`KVMerger` 风格 `weighted` merge
